...
Somente **elementos de identidade criados em código** (SVG), que não representam
nenhuma pessoa, show ou equipamento real:

| Arquivo | Uso |
| --- | --- |
| `favicon.svg` | ícone do site (`//_`) |
| `logo-cod-rebel-dj.svg` | marca escrita, para presskit e divulgação |
